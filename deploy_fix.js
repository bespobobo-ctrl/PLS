        ...
        {view === 'login' ? (
          ...
          >
             ...
             <div className='grid grid-cols-2 gap-4 flex-1'>
                <div className='glass-card p-6 flex flex-col justify-between items-start border-white/10'>
                ...
                <div className='glass-card p-6 flex flex-col justify-between items-start border-white/10 bg-white/5'>
             ...
             <div className='glass-card p-8 flex flex-col gap-2'>
                ...
                <div className='flex items-center gap-2'>
                   <div className='flex-1 h-1 bg-white/10 rounded-full overflow-hidden'>
                      <div className='w-3/4 h-full bg-pls-cyan'></div>
                   </div>
...
@theme {
  --color-pls-cyan: #00f2ff;
  --color-pls-purple: #9d3cff;
  --color-pls-red: #ff3c41;
  --color-pls-green: #3cff8e;
}

@import url('https://fonts.googleapis.com/css2?family=Unbounded:wght@400;700;900&family=Outfit:wght@300;400;600;800&display=swap');
...
.glass-card { background: var(--card); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); border: 1px solid var(--border); border-radius: 32px; }
.unbounded { font-family: 'Unbounded', cursive; }
.mesh-gradient {
    position: fixed; inset: 0; opacity: 0.3; z-index: 0; pointer-events: none;
    background: radial-gradient(at 0% 0%, #00f2ff 0, transparent 50%),
                radial-gradient(at 100% 0%, #9d3cff 0, transparent 50%);
    filter: blur(100px);
}
`;
...
console.log('✅ Fayllar mutlaqo toza formatda yozildi!');
